...
The async IIFE every ▶ button builds receives five parameters: `fable`,
...
Click ▶ and four labelled bars (Q1–Q4) should appear in the sandbox. The
middle pane logs the bins array the view is rendering from. Clicking ▶
